...
exports.viewCandidate = tryCatch(async (req, res) => {
  ...
  const candidate = await sequelize.query(`SELECT
        ...
        "reqCandidates"."candidateMiddleName",
    ...
    ${hiddenField}
        ...
        "reqCandidates"."candidateSummary",
        "reqCandidates"."candidateLinkedinUrl",
        "reqCandidates"."candidateGithubUrl",
        "reqCandidates"."candidateMaritalStatus",
        "reqCandidates"."candidateImmidiateJoiner",
        "reqCandidates"."candidateRevlentExperience",
        "reqCandidates"."candidatePreferlocation",
        "reqCandidates"."candidateCity",
        "reqCandidates"."isSourced",
