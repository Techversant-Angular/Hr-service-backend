...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(
      `ALTER TABLE "reqjobapplicants" ALTER COLUMN "candidateEmail" TYPE citext USING "candidateEmail"::citext;`
    );
  },
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(
      `ALTER TABLE "reqjobapplicants" ALTER COLUMN "candidateEmail" TYPE varchar(255);`
    );
